...
from AkkiX import app
from AkkiX.core.call import Akki
from AkkiX.misc import db
from AkkiX.utils.database import get_authuser_names, get_cmode
from AkkiX.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from AkkiX.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Akki.stop_stream(message.chat.id)
    except:
        pass
