...
from AkkiX import (Apple, Resso, SoundCloud, Spotify, Telegram,
                        YouTube, app)
from AkkiX.core.call import Akki
from AkkiX.utils import seconds_to_min, time_to_seconds
from AkkiX.utils.channelplay import get_channeplayCB
from AkkiX.utils.database import is_video_allowed
from AkkiX.utils.decorators.language import languageCB
from AkkiX.utils.decorators.play import PlayWrapper
from AkkiX.utils.formatters import formats
from AkkiX.utils.inline.play import (livestream_markup,
                                          playlist_markup,
                                          slider_markup, track_markup)
from AkkiX.utils.database import is_served_user
from AkkiX.utils.inline.playlist import botplaylist_markup
from AkkiX.utils.logger import play_logs
from AkkiX.utils.stream.stream import stream
...
@app.on_callback_query(
    filters.regex("AkkiymousAdmin") & ~BANNED_USERS
)
async def Akkiymous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(
    filters.regex("AkkiPlaylists") & ~BANNED_USERS
)
@languageCB
