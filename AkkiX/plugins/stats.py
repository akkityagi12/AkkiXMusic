...
from AkkiX.core.userbot import assistants
from AkkiX.misc import SUDOERS, pymongodb
from AkkiX.plugins import ALL_MODULES
from AkkiX.utils.database import (get_global_tops,
                                       get_particulars, get_queries,
                                       get_served_chats,
                                       get_served_users, get_sudoers,
                                       get_top_chats, get_topp_users)
from AkkiX.utils.decorators.language import language, languageCB
from AkkiX.utils.inline.stats import (back_stats_buttons,
                                           back_stats_markup,
                                           get_stats_markup,
...
**ᴍᴏᴅᴜʟᴇs:** {mod}
**ᴄʜᴀᴛs:** 1{served_chats}
**ᴜsᴇʀs:** {served_users} 
**ʙʟᴏᴄᴋᴇᴅ:** {blocked} 
**sᴜᴅᴏᴇʀs:** {sudoers} 
    
**ǫᴜᴇʀɪᴇs:** 1405{total_queries} 
