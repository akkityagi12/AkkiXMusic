...
import config
from AkkiX import Carbon, YouTube, app
from AkkiX.core.call import Akki
from AkkiX.misc import db
from AkkiX.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from AkkiX.utils.exceptions import AssistantErr
from AkkiX.utils.inline.play import (stream_markup, queue_markup,
                                          telegram_markup)
from AkkiX.utils.inline.playlist import close_markup
from AkkiX.utils.pastebin import Akkibin
from AkkiX.utils.stream.queue import put_queue, put_queue_index
from AkkiX.utils.thumbnails import gen_thumb, gen_qthumb
...
async def stream(
    ...
    if forceplay:
        await Akki.force_stop_stream(chat_id)
